...
void FileManager::writeTheOutputSetToFile(int startNumber, int EndNumber, int numberOfTerms, std::vector<Polynomial::term>& t)
{
	ofstream outputFile;
	try
	{
...
void FileManager::writeTheExpressionToFile(std::vector<Polynomial::term>& t, int numberOfTerm)
{
